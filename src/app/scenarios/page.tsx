...
export const metadata = {
  title: "Skenario Percakapan (Conversation Scenarios) · Mandarin Context Lab",
  description:
    "Latihan percakapan berbasis peran dan konteks nyata HSK 1: perkenalan, kedai teh, belanja buah, dan janji temu.",
};
        ...
        <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
          <div className="space-y-1">
            <h1 className="text-2xl sm:text-4xl font-black uppercase tracking-tight text-ink">
              Skenario Percakapan Nyata
            </h1>
            <p className="text-sm sm:text-base text-muted max-w-2xl leading-relaxed">
              Praktikkan dialog situasi nyata turn-based: padukan pelafalan nada, pemakaian kata
          ...
          <div className="shrink-0 font-mono text-xs text-muted flex items-center gap-2">
            ...
            <span>4 SITUASI NYATA HSK 1</span>
          </div>
        </div>
      </section>
